...
_result = 0;
_missionMarkerName = "Supplies_Marker";
_missionType = "Abandoned Supplies";
...
_vehicleClass = ["UralCivil","UralCivil2"] call BIS_fnc_selectRandom;
if(_vehicleClass == "UralCivil") then {_vehicleClass setVariable["water",round(random 400),true];_name = "Water supply truck";
};
if(_vehicleClass == "UralCivil2") then {_vehicleClass setVariable["food",round(random 400),true];_name = "Food supply truck";
};
